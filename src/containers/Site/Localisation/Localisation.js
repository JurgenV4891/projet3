...
class Localisation extends Component {
  ...
  rechercheEtablissement = (type) => {
    axios
      .get(
        `https://etablissements-publics.api.gouv.fr/v3/departements/08/${type}`
      )
      .then((response) => {
  ...
  render() {
    return (
      <>
        ...
        <Button
          variant="secondary"
          onClick={() => this.rechercheEtablissement("mairie")}
        >
          Mairie
        </Button>
        <Button
          variant="secondary"
          onClick={() => this.rechercheEtablissement("commissariat_police")}
        >
          Commissariat de police
        </Button>
        <Button
          variant="secondary"
          onClick={() => this.rechercheEtablissement("pole_emploi")}
        >
          Pôle emploi
        </Button>
        <Button
          variant="secondary"
          onClick={() => this.rechercheEtablissement("prefecture")}
        >
          Préfecture
        </Button>
        <Row>
          {this.state.recherche &&
            this.state.recherche.map((etablissement) => {
              return (
